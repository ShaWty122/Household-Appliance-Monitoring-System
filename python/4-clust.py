...
fin=fin.append(data)
df=pd.read_excel('DATASET_4.1.xlsx',sheet_name='Sheet2',header=None)
data=clust(df,"tv_dvd_digibox_lamp",centroid)
fin=fin.append(data)
df=pd.read_excel('DATASET_4.1.xlsx',sheet_name='Sheet3',header=None)
data=clust(df,"kettle_radio",centroid)
fin=fin.append(data)
df=pd.read_excel('DATASET_4.1.xlsx',sheet_name='Sheet4',header=None)
data=clust(df,"gas_boiler",centroid)
fin=fin.append(data)
df=pd.read_excel('DATASET_4.1.xlsx',sheet_name='Sheet5',header=None)
data=clust(df,"freezer",centroid)
fin=fin.append(data)
df=pd.read_excel('DATASET_4.1.xlsx',sheet_name='Sheet6',header=None)
...
#for i in range(len(data['value'])):
 #   ones.append('tv_dvd_digibox_lamp')
